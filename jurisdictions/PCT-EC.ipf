# =============================================================================
# IPFLang Jurisdiction: PCT-EC
# =============================================================================
# Entry of national phase entry in Ecuador
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-EC.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase entry in Ecuador'
...
# File name: PCT-EC-OFF
# File content: Official fees for PCT national phase: Ecuador
# Valid until n/a
...
LET Fee1 AS 596.49
YIELD Fee1
YIELD Fee1 * 0.1 * (SheetCount-20) IF SheetCount GT 20 #10% of base fee for each sheet > 20
ENDCOMPUTE

COMPUTE FEE OFF_Renewal
LET RenFee1 AS 125
LET RenFee2 AS 145
LET RenFee3 AS 158.20
...
RETURN Jurisdiction AS 'EC'
RETURN JurisdictionName AS 'Entry of national phase entry in Ecuador'
