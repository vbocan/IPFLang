# =============================================================================
# IPFLang Jurisdiction: PCT-VC
# =============================================================================
# Entry of national phase in Saint Vincent and the Grenadines
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-VC.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Saint Vincent and the Grenadines'
...
# File name: PCT-VC-OFF
# File content: Official fees for PCT national phase: Saint Vincent and the Grenadines
# Valid until n/a
...
RETURN Jurisdiction AS 'VC'
RETURN JurisdictionName AS 'Entry of national phase in Saint Vincent and the Grenadines'
