# =============================================================================
# IPFLang Jurisdiction: PCT-TM
# =============================================================================
# Entry of national phase in Turkmenistan
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ea.ipf jurisdictions/PCT-TM.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Turkmenistan'
...
# File name: PCT-TM-OFF
# File content: Official fees for PCT national phase: Turkmenistan
# Valid until n/a
...
LET Fee1 AS 25
YIELD Fee1*(IndependentClaimCount -1)
ENDCOMPUTE

COMPUTE FEE OFF_Renewal1
LET Fee1 AS 50
YIELD Fee1
ENDCOMPUTE
...
# Translation fee per word into Turkmen, Russian
...
RETURN Jurisdiction AS 'TM'
RETURN JurisdictionName AS 'Entry of national phase in Turkmenistan'
