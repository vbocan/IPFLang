# =============================================================================
# IPFLang Jurisdiction: PCT-TZ
# =============================================================================
# Entry of national phase in United Republic of Tanzania
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ap.ipf jurisdictions/PCT-TZ.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in United Republic of Tanzania'
...
# File name: PCT-TZ-OFF
# File content: Official fees for PCT national phase: United Republic of Tanzania
# Valid until n/a
...
RETURN Currency AS 'TZS'
RETURN Jurisdiction AS 'TZ'
RETURN JurisdictionName AS 'Entry of national phase in United Republic of Tanzania'
