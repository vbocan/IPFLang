# =============================================================================
# IPFLang Jurisdiction: PCT-CZ
# =============================================================================
# Entry of national phase entry in Czechia
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ep.ipf jurisdictions/PCT-CZ.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase entry in Czechia'
...
# File name: PCT-CZ-OFF
# File content: Official fees for PCT national phase: Czechia
# Valid until n/a
...
COMPUTE FEE OFF_ExaminationFee OPTIONAL #36 months after priority
LET Fee1 AS 3000
LET Fee2 AS 500 #(claim fee > 10)
YIELD Fee1
YIELD Fee2 * (ClaimCount-10) IF ClaimCount GT 10
ENDCOMPUTE
...
# Translation fee per word into Czech
...
RETURN Currency AS 'CZK'
RETURN Jurisdiction AS 'CZ'
RETURN JurisdictionName AS 'Entry of national phase entry in Czechia'
