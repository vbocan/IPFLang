# =============================================================================
# IPFLang Jurisdiction: PCT-SC
# =============================================================================
# Entry of national phase in Seychelles
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ap.ipf jurisdictions/PCT-SC.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Seychelles'
...
# File name: PCT-SC-OFF
# File content: Official fees for PCT national phase: Seychelles
# Valid until n/a
...
#annuities due as of 5 years; inconsistent information at WIPO
...
RETURN Currency AS 'SCR'
RETURN Jurisdiction AS 'SC'
RETURN JurisdictionName AS 'Entry of national phase in Seychelles'
