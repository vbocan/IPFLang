# =============================================================================
# IPFLang Jurisdiction: PCT-MZ
# =============================================================================
# Entry of national phase in Mozambique
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ap.ipf jurisdictions/PCT-MZ.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Mozambique'
...
# File name: PCT-MZ-OFF
# File content: Official fees for PCT national phase: Mozambique
# Valid until n/a
# Is newer than 30 days: False
 #WIPO mentions MZM which has been replaced in 2008
# Fees keywords: []
...
COMPUTE FEE OFF_Renewal #annuities as of year 3 payable after grant 
LET RenFee1 AS 1275
LET RenFee2 AS 1725

LET RenMonth AS ROUND ( ApplicationDate!MONTHSTONOW ) #calculate difference in months to today
YIELD RenFee1 IF RenMonth GTE 12
YIELD RenFee2 IF RenMonth GTE 24
ENDCOMPUTE
...
RETURN Currency AS 'MZN'
RETURN Jurisdiction AS 'MZ'
RETURN JurisdictionName AS 'Entry of national phase in Mozambique'
