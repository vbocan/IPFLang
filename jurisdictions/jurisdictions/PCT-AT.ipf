# =============================================================================
# IPFLang Jurisdiction: PCT-AT
# =============================================================================
# Entry of national phase in Austria
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ep.ipf jurisdictions/PCT-AT.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Austria'
...
# File name: PCT-AT-OFF
# File content: Official fees for PCT regional phase: Austria
# Valid until n/a

COMPUTE FEE OFF_BasicNationalFee
YIELD 52 #entry fee
YIELD 50 #document fee
ENDCOMPUTE

COMPUTE FEE OFF_SearchExaminationFee
YIELD 292<EUR>
YIELD 104*( ( ClaimCount - 10 ) / 10 ) IF ClaimCount GT 10
ENDCOMPUTE

COMPUTE FEE OFF_PublicationFee OPTIONAL
YIELD 208<EUR>
YIELD 135*( ( SheetCount - 15 ) / 15 ) IF SheetCount GT 15
ENDCOMPUTE

# Annuities payable only after grant
...
# Translation fee per word into German
...
VERIFY COMPLETE FEE OFF_SearchExaminationFee
...
RETURN Jurisdiction AS 'AT'
RETURN JurisdictionName AS 'Entry of national phase in Austria'
