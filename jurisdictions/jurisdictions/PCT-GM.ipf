# =============================================================================
# IPFLang Jurisdiction: PCT-GM
# =============================================================================
# Entry of national phase in Gambia
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ap.ipf jurisdictions/PCT-GM.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Gambia'
...
# File name: PCT-GM-OFF
# File content: Official fees for PCT national phase: Gambia
# Valid until n/a
...
RETURN Currency AS 'GMD'
RETURN Jurisdiction AS 'GM'
RETURN JurisdictionName AS 'Entry of national phase in Gambia'
