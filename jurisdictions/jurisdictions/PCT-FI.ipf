# =============================================================================
# IPFLang Jurisdiction: PCT-FI
# =============================================================================
# Entry of national phase in Finland
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ep.ipf jurisdictions/PCT-FI.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Finland'
...
# File name: PCT-FI-OFF
# File content: Official fees for PCT national phase: Finland
# Valid until n/a
...
LET CF1 AS 50
YIELD CF1*(ClaimCount-15) IF ClaimCount GT 15
ENDCOMPUTE
...
# Translation fee per word into English, Finnish, Swedish
...
RETURN Jurisdiction AS 'FI'
RETURN JurisdictionName AS 'Entry of national phase in Finland'
