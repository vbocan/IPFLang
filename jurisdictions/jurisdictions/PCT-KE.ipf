# =============================================================================
# IPFLang Jurisdiction: PCT-KE
# =============================================================================
# Entry of national phase in Kenya
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ap.ipf jurisdictions/PCT-KE.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Kenya'
...
# File name: PCT-KE-OFF
# File content: Official fees for PCT national phase: Kenya
# Valid until n/a
...
RETURN Jurisdiction AS 'KE'
RETURN JurisdictionName AS 'Entry of national phase in Kenya'
