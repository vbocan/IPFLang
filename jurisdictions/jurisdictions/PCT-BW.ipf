# =============================================================================
# IPFLang Jurisdiction: PCT-BW
# =============================================================================
# Entry of national phase in Botswana
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ap.ipf jurisdictions/PCT-BW.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Botswana'
...
RETURN Currency AS 'BWP'
RETURN Jurisdiction AS 'BW'
RETURN JurisdictionName AS 'Entry of national phase in Botswana'
