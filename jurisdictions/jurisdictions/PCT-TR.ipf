# =============================================================================
# IPFLang Jurisdiction: PCT-TR
# =============================================================================
# Entry of national phase in Turkey
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ep.ipf jurisdictions/PCT-TR.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Turkey'
...
# File content: Official fees for PCT national phase: Türkiye
# Valid until n/a
...
# Translation fee per word into Turkish
...
RETURN Jurisdiction AS 'TR'
RETURN JurisdictionName AS 'Entry of national phase in Turkey'
