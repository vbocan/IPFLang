# =============================================================================
# IPFLang Jurisdiction: PCT-PT
# =============================================================================
# Entry of national phase in Portugal
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ep.ipf jurisdictions/PCT-PT.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Portugal'
...
# File name: PCT-PT-OFF
# File content: Official fees for PCT national phase: Portugal
# Valid until n/a
...
RETURN Jurisdiction AS 'PT'
RETURN JurisdictionName AS 'Entry of national phase in Portugal'
