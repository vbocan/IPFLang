# =============================================================================
# IPFLang Jurisdiction: PCT-IS
# =============================================================================
# Entry of national phase in Iceland
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ep.ipf jurisdictions/PCT-IS.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Iceland'
...
# File name: PCT-IS-OFF
# File content: Official fees for PCT national phase: Iceland
# Valid until n/a
...
# Language: Danish, English, Icelandic, Norwegian, Swedish
# =============================================================================
...
# Translation fee per word into Danish, English, Icelandic, Norwegian, Swedish
...
RETURN Currency AS 'ISK'
RETURN Jurisdiction AS 'IS'
RETURN JurisdictionName AS 'Entry of national phase in Iceland'
