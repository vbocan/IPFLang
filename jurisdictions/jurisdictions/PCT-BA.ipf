# =============================================================================
# IPFLang Jurisdiction: PCT-BA
# =============================================================================
# Entry of national phase in Bosnia & Herzegovina
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ep.ipf jurisdictions/PCT-BA.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Bosnia & Herzegovina'
...
# File name: PCT-BA-OFF
# File content: Official fees for PCT national phase: Bosnia and Herzegovina
# Valid until n/a
...
YIELD 60<BAM>
YIELD 11*(ClaimCount-10) IF ClaimCount GT 10
YIELD 3*(SheetCount-30) IF SheetCount GT 30
ENDCOMPUTE

# No annuities payable before grant
...
# Translation fee per word into Bosnian, Croatian, Serbian
...
RETURN Currency AS 'BAM'
RETURN Jurisdiction AS 'BA'
RETURN JurisdictionName AS 'Entry of national phase in Bosnia & Herzegovina'
