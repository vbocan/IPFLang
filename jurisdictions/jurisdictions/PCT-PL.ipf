# =============================================================================
# IPFLang Jurisdiction: PCT-PL
# =============================================================================
# Entry of national phase in Poland
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ep.ipf jurisdictions/PCT-PL.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Poland'
...
# File name: PCT-PL-OFF
# File content: Official fees for PCT national phase: Poland
# Valid until n/a
# Is newer than 30 days: False
# Fees keywords: ['sheet', 'claims', 'priority']

COMPUTE FEE OFF_BasicNationalFee
LET Fee1 AS 350
LET Fee2 AS 550
YIELD Fee1 IF IPRP NEQ IPRP_NONE
YIELD Fee2 IF IPRP EQ IPRP_NONE
ENDCOMPUTE

COMPUTE FEE OFF_SheetFee
LET Fee1 AS 25
YIELD Fee1*(SheetCount-20) IF SheetCount GT 20
ENDCOMPUTE
...
#first annual fee due with 3 months of receipt of invitation to pay
...
# Translation fee per word into Polish
...
RETURN Currency AS 'PLN'
RETURN Jurisdiction AS 'PL'
RETURN JurisdictionName AS 'Entry of national phase in Poland'
