# =============================================================================
# IPFLang Jurisdiction: PCT-DE
# =============================================================================
# Entry of national phase entry in Germany
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ep.ipf jurisdictions/PCT-DE.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase entry in Germany'
...
# File name: PCT-DE-OFF
# File content: Official fees for PCT national phase: Germany
# Valid until n/a
...
COMPUTE FEE OFF_ExaminationFee OPTIONAL # 7 years after filing
LET Fee1 AS 150
LET Fee2 AS 350
YIELD Fee1 IF ISR_AVAILABLE EQ TRUE
YIELD Fee2 IF ISR_AVAILABLE EQ FALSE
ENDCOMPUTE
...
RETURN Jurisdiction AS 'DE'
RETURN JurisdictionName AS 'Entry of national phase entry in Germany'
