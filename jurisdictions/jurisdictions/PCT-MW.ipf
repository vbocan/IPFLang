# =============================================================================
# IPFLang Jurisdiction: PCT-MW
# =============================================================================
# Entry of national phase in Malawi
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ap.ipf jurisdictions/PCT-MW.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Malawi'
...
# File name: PCT-MW-OFF
# File content: Official fees for PCT national phase: Malawi
# Valid until n/a
...
RETURN Currency AS 'MWK'
RETURN Jurisdiction AS 'MW'
RETURN JurisdictionName AS 'Entry of national phase in Malawi'
