# =============================================================================
# IPFLang Jurisdiction: PCT-TJ
# =============================================================================
# Entry of national phase in Tajikistan
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ea.ipf jurisdictions/PCT-TJ.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Tajikistan'
...
# File name: PCT-TJ-OFF
# File content: Official fees for PCT national phase: Tajikistan
# Valid until n/a
...
# Translation fee per word into Tajik (Farsi), Russian
...
RETURN Jurisdiction AS 'TJ'
RETURN JurisdictionName AS 'Entry of national phase in Tajikistan'
