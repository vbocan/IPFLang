# =============================================================================
# IPFLang Jurisdiction: PCT-AZ
# =============================================================================
# Entry of national phase in Azerbaijan
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ea.ipf jurisdictions/PCT-AZ.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Azerbaijan'
...
CASE RenMonth GTE 24 AS
   YIELD 50<AZN> IF EntitySize NEQ Entity_Person
   YIELD 10<AZN> IF EntitySize EQ Entity_Person
ENDCASE
...
# Translation fee per word into Azerbaijani
...
RETURN Currency AS 'AZN'
RETURN Jurisdiction AS 'AZ'
RETURN JurisdictionName AS 'Entry of national phase in Azerbaijan'
