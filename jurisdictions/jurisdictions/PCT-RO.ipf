# =============================================================================
# IPFLang Jurisdiction: PCT-RO
# =============================================================================
# Entry of national phase in Romania
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ep.ipf jurisdictions/PCT-RO.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Romania'
...
# File name: PCT-RO-OFF
# File content: Official fees for PCT national phase: Romania
# Valid until n/a
# Is newer than 30 days: False
# Fees keywords: ['claims', 'priority']
...
COMPUTE FEE OFF_PriorityFee #if paid within 3 months of entering national phase; when paid after three months different fees apply
LET Fee1 AS 50
...
LET CFee AS 15
YIELD CFee*(ClaimCount-5) IF ClaimCount GT 5

LET PFee AS 10
YIELD PFee*(SheetCount-20) IF SheetCount GT 20

ENDCOMPUTE

#annuities payable after grant
...
# Translation fee per word into Romanian
...
RETURN Jurisdiction AS 'RO'
RETURN JurisdictionName AS 'Entry of national phase in Romania'
