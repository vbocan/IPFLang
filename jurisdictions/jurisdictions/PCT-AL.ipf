# =============================================================================
# IPFLang Jurisdiction: PCT-AL
# =============================================================================
# Entry of national phase in Albania
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ep.ipf jurisdictions/PCT-AL.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Albania'
...
# File name: PCT-AL-OFF
# File content: Official fees for PCT regional phase: Albania
# Valid until n/a
...
#patents are granted without examination; within 10 years of NPE an examination report from another office must be filed to effect grant
...
# Translation fee per word into Albanian
...
RETURN Currency AS 'ALL'
RETURN Jurisdiction AS 'AL'
RETURN JurisdictionName AS 'Entry of national phase in Albania'
