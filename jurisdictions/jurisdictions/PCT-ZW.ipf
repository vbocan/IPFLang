# =============================================================================
# IPFLang Jurisdiction: PCT-ZW
# =============================================================================
# Entry of national phase in Zimbabwe
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ap.ipf jurisdictions/PCT-ZW.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Zimbabwe'
...
# File name: PCT-ZW-OFF
# File content: Official fees for PCT national phase: Zimbabwe
# Valid until n/a
# Is newer than 30 days: False
 #ZWD is on WIPO site but doesn't seem to be internationally accepted.
# Fees keywords: []
...
RETURN Currency AS 'ZWL'
RETURN Jurisdiction AS 'ZW'
RETURN JurisdictionName AS 'Entry of national phase in Zimbabwe'
