# =============================================================================
# IPFLang Jurisdiction: PCT-SE
# =============================================================================
# Entry of national phase in Sweden
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ep.ipf jurisdictions/PCT-SE.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Sweden'
...
# File name: PCT-SE-OFF
# File content: Official fees for PCT national phase: Sweden
# Valid until n/a
...
# Translation fee per word into Swedish, English
...
RETURN Currency AS 'SEK'
RETURN Jurisdiction AS 'SE'
RETURN JurisdictionName AS 'Entry of national phase in Sweden'
