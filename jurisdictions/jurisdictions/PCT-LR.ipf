# =============================================================================
# IPFLang Jurisdiction: PCT-LR
# =============================================================================
# Entry of national phase in Liberia
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ap.ipf jurisdictions/PCT-LR.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Liberia'
...
# File name: PCT-LR-OFF
# File content: Official fees for PCT national phase: Liberia
# Valid until n/a
...
#Examination fee is due but unknown
...
RETURN Jurisdiction AS 'LR'
RETURN JurisdictionName AS 'Entry of national phase in Liberia'
