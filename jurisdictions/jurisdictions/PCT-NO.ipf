# =============================================================================
# IPFLang Jurisdiction: PCT-NO
# =============================================================================
# Entry of national phase in Norway
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ep.ipf jurisdictions/PCT-NO.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Norway'
...
# File name: PCT-NO-OFF
# File content: Official fees for PCT national phase: Norway
# Valid until n/a
...
# Translation fee per word into English, Norwegian
...
RETURN Currency AS 'NOK'
RETURN Jurisdiction AS 'NO'
RETURN JurisdictionName AS 'Entry of national phase in Norway'
