# =============================================================================
# IPFLang Jurisdiction: PCT-MK
# =============================================================================
# Entry of national phase in North Macedonia
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ep.ipf jurisdictions/PCT-MK.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in North Macedonia'
...
# File name: PCT-MK-OFF
# File content: Official fees for PCT national phase: North Macedonia
# Valid until n/a
...
# Translation fee per word into Macedonian
...
RETURN Currency AS 'MKD'
RETURN Jurisdiction AS 'MK'
RETURN JurisdictionName AS 'Entry of national phase in North Macedonia'
