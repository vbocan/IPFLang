# =============================================================================
# IPFLang Jurisdiction: PCT-HR
# =============================================================================
# Entry of national phase in Croatia
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ep.ipf jurisdictions/PCT-HR.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Croatia'
...
# File name: PCT-HR-OFF
# File content: Official fees for PCT national phase: Croatia
# Valid until n/a
# Is newer than 30 days: False
# Fees keywords: ['claims', 'sheet', 'claim']
...
# Translation fee per word into Croatian
...
RETURN Jurisdiction AS 'HR'
RETURN JurisdictionName AS 'Entry of national phase in Croatia'
