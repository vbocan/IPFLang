# =============================================================================
# IPFLang Jurisdiction: PCT-EE
# =============================================================================
# Entry of national phase entry in Estonia
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ep.ipf jurisdictions/PCT-EE.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase entry in Estonia'
...
# File name: PCT-EE-OFF
# File content: Official fees for PCT national phase: Estonia
# Valid until n/a
...
# Translation fee per word into Estonian
...
RETURN Jurisdiction AS 'EE'
RETURN JurisdictionName AS 'Entry of national phase entry in Estonia'
