# =============================================================================
# IPFLang Jurisdiction: PCT-ES
# =============================================================================
# Entry of national phase in Spain
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ep.ipf jurisdictions/PCT-ES.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Spain'
...
# File name: PCT-ES-OFF
# File content: Official fees for PCT national phase: Spain
# Valid until n/a
...
COMPUTE FEE OFF_BasicSearchFee
LET Fee1 AS 593.65
YIELD Fee1
ENDCOMPUTE

COMPUTE FEE OFF_BasicExaminationFee
LET Fee1 AS 337.96
YIELD Fee1
ENDCOMPUTE

#annuities due after grant
...
VERIFY COMPLETE FEE OFF_BasicSearchFee
VERIFY COMPLETE FEE OFF_BasicExaminationFee
...
RETURN Jurisdiction AS 'ES'
RETURN JurisdictionName AS 'Entry of national phase in Spain'
