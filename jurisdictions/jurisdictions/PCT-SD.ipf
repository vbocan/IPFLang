# =============================================================================
# IPFLang Jurisdiction: PCT-SD
# =============================================================================
# Entry of national phase in Sudan
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ap.ipf jurisdictions/PCT-SD.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Sudan'
...
# File name: PCT-SD-OFF
# File content: Official fees for PCT national phase: Sudan
# Valid until n/a
...
RETURN Currency AS 'SDG'
RETURN Jurisdiction AS 'SD'
RETURN JurisdictionName AS 'Entry of national phase in Sudan'
