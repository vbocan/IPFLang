# =============================================================================
# IPFLang Jurisdiction: PCT-NA
# =============================================================================
# Entry of national phase in Namibia
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ap.ipf jurisdictions/PCT-NA.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Namibia'
...
# File name: PCT-NA-OFF
# File content: Official fees for PCT national phase: Namibia
# Valid until n/a
...
RETURN Currency AS 'NAD'
RETURN Jurisdiction AS 'NA'
RETURN JurisdictionName AS 'Entry of national phase in Namibia'
