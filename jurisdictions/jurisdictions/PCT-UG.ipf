# =============================================================================
# IPFLang Jurisdiction: PCT-UG
# =============================================================================
# Entry of national phase in Uganda
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ap.ipf jurisdictions/PCT-UG.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Uganda'
...
# File name: PCT-UG-OFF
# File content: Official fees for PCT national phase: Uganda
# Valid until n/a
...
RETURN Jurisdiction AS 'UG'
RETURN JurisdictionName AS 'Entry of national phase in Uganda'
