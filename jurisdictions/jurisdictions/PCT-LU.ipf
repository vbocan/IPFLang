# =============================================================================
# IPFLang Jurisdiction: PCT-LU
# =============================================================================
# Entry of national phase in Luxemburg
#
...
# Usage:
#   dotnet run --project src/IPFLang.CLI -- compose bases/base_ep.ipf jurisdictions/PCT-LU.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Luxemburg'
...
# File name: PCT-LU-OFF
# File content: Official fees for PCT national phase: Luxembourg
# Valid until n/a
...
RETURN Jurisdiction AS 'LU'
RETURN JurisdictionName AS 'Entry of national phase in Luxemburg'
