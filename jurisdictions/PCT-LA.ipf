# =============================================================================
# IPFLang Jurisdiction: PCT-LA
# =============================================================================
# Entry of national phase in Lao People’s Democratic Republic 
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-LA.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Lao People’s Democratic Republic '
...
# File name: PCT-LA-OFF
# File content: Official fees for PCT national phase: Lao People’s Democratic Republic
# Valid until n/a
...
#not coded: Consultation fee, Publication fee, Service fee as unknown when these are payable 
...
# Translation fee per word into Lao
...
RETURN Currency AS 'LAK'
RETURN Jurisdiction AS 'LA'
RETURN JurisdictionName AS 'Entry of national phase in Lao People’s Democratic Republic '
