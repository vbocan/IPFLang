# =============================================================================
# IPFLang Jurisdiction: PCT-TH
# =============================================================================
# Entry of national phase in Thailand
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-TH.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Thailand'
...
# File name: PCT-TH-OFF
# File content: Official fees for PCT national phase: Thailand
# Valid until n/a
...
COMPUTE FEE OFF_ExaminationFee OPTIONAL #5 years after publication
LET Fee1 AS 250
YIELD Fee1
ENDCOMPUTE
...
# Translation fee per word into Thai
...
RETURN Currency AS 'THB'
RETURN Jurisdiction AS 'TH'
RETURN JurisdictionName AS 'Entry of national phase in Thailand'
