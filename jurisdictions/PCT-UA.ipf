# =============================================================================
# IPFLang Jurisdiction: PCT-UA
# =============================================================================
# Entry of national phase in Ukraine
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-UA.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Ukraine'
...
# File name: PCT-UA-OFF
# File content: Official fees for PCT national phase: Ukraine
# Valid until n/a
...
LET Fee1 AS 640
YIELD Fee1*( ( SheetCount - 150 ) / 50 ) IF SheetCount GT 150
ENDCOMPUTE

COMPUTE FEE OFF_ClaimFee
LET Fee1 AS 160
YIELD Fee1*(ClaimCount-3) IF ClaimCount GT 3
ENDCOMPUTE

COMPUTE FEE OFF_ExaminationFee OPTIONAL #3 years as of IFD
LET Fee1 AS 6000
YIELD Fee1*IndependentClaimCount
ENDCOMPUTE
...
# Translation fee per word into Ukrainian
...
RETURN Currency AS 'UAH'
RETURN Jurisdiction AS 'UA'
RETURN JurisdictionName AS 'Entry of national phase in Ukraine'
