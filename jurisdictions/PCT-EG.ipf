# =============================================================================
# IPFLang Jurisdiction: PCT-EG
# =============================================================================
# Entry of national phase in Egypt
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-EG.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Egypt'
...
# File name: PCT-EG-OFF
# File content: Official fees for PCT national phase: Egypt
# Valid until n/a
...
RETURN Currency AS 'EGP'
RETURN Jurisdiction AS 'EG'
RETURN JurisdictionName AS 'Entry of national phase in Egypt'
