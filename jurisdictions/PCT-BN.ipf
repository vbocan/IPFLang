# =============================================================================
# IPFLang Jurisdiction: PCT-BN
# =============================================================================
# entry of national phase in Brunei Darussalam
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-BN.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'entry of national phase in Brunei Darussalam'
...
# File name: PCT-BN-OFF
# File content: Official fees for PCT national phase: Brunei Darussalam
# Valid until n/a
...
#no annuities due before year 5
...
RETURN Currency AS 'BND'
RETURN Jurisdiction AS 'BN'
RETURN JurisdictionName AS 'entry of national phase in Brunei Darussalam'
