# =============================================================================
# IPFLang Jurisdiction: PCT-AP
# =============================================================================
# Entry of regional phase in ARIPO
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-AP.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of regional phase in ARIPO'
...
YIELD 350<USD>
YIELD 20*(SheetCount-30) IF SheetCount GT 30
YIELD 50*(ClaimCount-10) IF ClaimCount GT 10
ENDCOMPUTE

COMPUTE FEE OFF_SearchFee
YIELD 0 IF ISR_AVAILABLE EQ TRUE
YIELD 300<USD> IF ISR_AVAILABLE EQ FALSE
ENDCOMPUTE
...
YIELD 50 # year 1
YIELD 70<USD> IF RenMonth GTE 12 # year 2
YIELD 90<USD> IF RenMonth GTE 24 # year 3
ENDCOMPUTE
...
RETURN Jurisdiction AS 'AP'
RETURN JurisdictionName AS 'Entry of regional phase in ARIPO'
