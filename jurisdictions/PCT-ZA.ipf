# =============================================================================
# IPFLang Jurisdiction: PCT-ZA
# =============================================================================
# Entry of national phase in South Africa
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-ZA.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in South Africa'
...
# File name: PCT-ZA-OFF
# File content: Official fees for PCT national phase: South Africa
# Valid until n/a
...
RETURN Currency AS 'ZAR'
RETURN Jurisdiction AS 'ZA'
RETURN JurisdictionName AS 'Entry of national phase in South Africa'
