# =============================================================================
# IPFLang Jurisdiction: PCT-WS
# =============================================================================
# Entry of national phase in Samoa
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-WS.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Samoa'
...
# File name: PCT-WS-OFF
# File content: Official fees for PCT national phase: Samoa
# Valid until n/a
# Is newer than 30 days: False
 # WIPO says SAT which is an older alternative
# Fees keywords: []
...
COMPUTE FEE OFF_SearchFee OPTIONAL
LET Fee1 AS 30
YIELD Fee1
ENDCOMPUTE

#annuities after 5th year of IFD
...
RETURN Currency AS 'WST'
RETURN Jurisdiction AS 'WS'
RETURN JurisdictionName AS 'Entry of national phase in Samoa'
