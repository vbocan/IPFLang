# =============================================================================
# IPFLang Jurisdiction: PCT-DJ
# =============================================================================
# Entry of national phase entry in Djibouti
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-DJ.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase entry in Djibouti'
...
# File name: PCT-DJ-OFF
# File content: Official fees for PCT national phase: Djibouti
# Valid until n/a
...
RETURN Currency AS 'DJF'
RETURN Jurisdiction AS 'DJ'
RETURN JurisdictionName AS 'Entry of national phase entry in Djibouti'
