# =============================================================================
# IPFLang Jurisdiction: PCT-HN
# =============================================================================
# Entry of national phase in Honduras
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-HN.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Honduras'
...
# File name: PCT-HN-OFF
# File content: Official fees for PCT national phase: Honduras
# Valid until n/a
...
RETURN Currency AS 'HNL'
RETURN Jurisdiction AS 'HN'
RETURN JurisdictionName AS 'Entry of national phase in Honduras'
