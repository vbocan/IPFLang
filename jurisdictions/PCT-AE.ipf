# =============================================================================
# IPFLang Jurisdiction: PCT-AE
# =============================================================================
# Entry of national phase in UAE
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-AE.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in UAE'
...
# File name: PCT-AE-OFF
# File content: Official fees for PCT regional phase: UAE
# Valid until n/a

COMPUTE FEE OFF_BasicNationalFee
YIELD 2000<AED> IF EntitySize NEQ Entity_Person
YIELD 1000<AED> IF EntitySize EQ Entity_Person
ENDCOMPUTE

COMPUTE FEE OFF_PublicationFee OPTIONAL
YIELD 800<AED> IF EntitySize NEQ Entity_Person
YIELD 400<AED> IF EntitySize EQ Entity_Person
ENDCOMPUTE

# Annuities are due as of the first anniversary based on the filing date (not end of the month)
COMPUTE FEE OFF_Renewal
LET RenMonth AS ROUND ( ApplicationDate!MONTHSTONOW ) #calculate difference in months to today
YIELD 800 #for year 2 (assumption: the NPE will always occur a year after filing date)
YIELD 840<AED> IF RenMonth GTE 12 #year 3
YIELD 880<AED> IF RenMonth GTE 24 #year 4
ENDCOMPUTE
...
# Translation fee per word into Arabic, English
...
RETURN Currency AS 'AED'
RETURN Jurisdiction AS 'AE'
RETURN JurisdictionName AS 'Entry of national phase in UAE'
