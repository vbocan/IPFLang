# =============================================================================
# IPFLang Jurisdiction: PCT-PE
# =============================================================================
# Entry of national phase in Peru
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-PE.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Peru'
...
# File name: PCT-PE-OFF
# File content: Official fees for PCT national phase: Peru
# Valid until n/a
...
COMPUTE FEE OFF_Renewal #it seems only one annuity fee is payable for the first year until grant
LET Fee1 AS 140
YIELD Fee1
ENDCOMPUTE
...
RETURN Currency AS 'PEN'
RETURN Jurisdiction AS 'PE'
RETURN JurisdictionName AS 'Entry of national phase in Peru'
