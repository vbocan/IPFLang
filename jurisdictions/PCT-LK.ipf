# =============================================================================
# IPFLang Jurisdiction: PCT-LK
# =============================================================================
# Entry of national phase in Sri Lanka
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-LK.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Sri Lanka'
...
# File name: PCT-LK-OFF
# File content: Official fees for PCT national phase: Sri Lanka
# Valid until n/a
...
RETURN Currency AS 'LKR'
RETURN Jurisdiction AS 'LK'
RETURN JurisdictionName AS 'Entry of national phase in Sri Lanka'
