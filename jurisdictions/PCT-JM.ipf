# =============================================================================
# IPFLang Jurisdiction: PCT-JM
# =============================================================================
# Entry of national phase in Jamaica
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-JM.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Jamaica'
...
# File name: PCT-JM-OFF
# File content: Official fees for PCT national phase: Jamaica
# Valid until n/a
...
COMPUTE FEE OFF_AgentAppointmentFee
LET Fee1 AS 4500
YIELD Fee1
ENDCOMPUTE

COMPUTE FEE OFF_SheetFee OPTIONAL #2 months after invitation
LET Fee1 AS 3500
LET Fee2 AS 500
YIELD Fee1
YIELD Fee2*(SheetCount-4) IF SheetCount GT 4
ENDCOMPUTE
...
VERIFY COMPLETE FEE OFF_AgentAppointmentFee
...
RETURN Currency AS 'JMD'
RETURN Jurisdiction AS 'JM'
RETURN JurisdictionName AS 'Entry of national phase in Jamaica'
