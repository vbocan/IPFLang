# =============================================================================
# IPFLang Jurisdiction: PCT-ID
# =============================================================================
# Entry of national phase in Indonesia
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-ID.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Indonesia'
...
# File name: PCT-ID-OFF
# File content: Official fees for PCT national phase: Indonesia
# Valid until n/a
# Is newer than 30 days: False
# Fees keywords: ['page', 'claim']
...
# Translation fee per word into Indonesian
...
RETURN Currency AS 'IDR'
RETURN Jurisdiction AS 'ID'
RETURN JurisdictionName AS 'Entry of national phase in Indonesia'
