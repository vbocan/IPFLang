# =============================================================================
# IPFLang Jurisdiction: PCT-DO
# =============================================================================
# Entry of national phase entry in Dominican Republic
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-DO.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase entry in Dominican Republic'
...
# File name: PCT-DO-OFF
# File content: Official fees for PCT national phase: Dominican Republic
# Valid until n/a
...
LET RenFee AS 6610 #per year as of second year
...
RETURN Currency AS 'DOP'
RETURN Jurisdiction AS 'DO'
RETURN JurisdictionName AS 'Entry of national phase entry in Dominican Republic'
