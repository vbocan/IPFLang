# =============================================================================
# IPFLang Jurisdiction: PCT-CR
# =============================================================================
# Entry of national phase entry in Costa Rica
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-CR.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase entry in Costa Rica'
...
# File name: PCT-CR-OFF
# File content: Official fees for PCT national phase: Costa Rica
# Valid until n/a
...
LET Fee1 AS 500
YIELD Fee1
YIELD -Fee1*0.7 IF EntitySize EQ Entity_Small OR EntitySize EQ Entity_Person OR EntitySize EQ Entity_Micro
ENDCOMPUTE
...
COMPUTE FEE OFF_RegistrationFee OPTIONAL
LET Fee1 AS 500
YIELD Fee1
YIELD -Fee1*0.7 IF EntitySize EQ Entity_Small OR EntitySize EQ Entity_Person OR EntitySize EQ Entity_Micro
ENDCOMPUTE

#annuities only payable after grant
...
VERIFY COMPLETE FEE OFF_RegistrationFee
...
RETURN Jurisdiction AS 'CR'
RETURN JurisdictionName AS 'Entry of national phase entry in Costa Rica'
