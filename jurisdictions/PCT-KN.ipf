# =============================================================================
# IPFLang Jurisdiction: PCT-KN
# =============================================================================
# Entry of national phase in Saint Kitts and Nevis
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-KN.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Saint Kitts and Nevis'
...
# File name: PCT-KN-OFF
# File content: Official fees for PCT national phase: Saint Kitts and Nevis
# Valid until n/a
...
RETURN Jurisdiction AS 'KN'
RETURN JurisdictionName AS 'Entry of national phase in Saint Kitts and Nevis'
