# =============================================================================
# IPFLang Jurisdiction: PCT-CO
# =============================================================================
# Entry of national phase in Colombia
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-CO.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Colombia'
...
# File name: PCT-CO-OFF
# File content: Official fees for PCT national phase: Colombia
# Valid until n/a
...
RETURN Currency AS 'COP'
RETURN Jurisdiction AS 'CO'
RETURN JurisdictionName AS 'Entry of national phase in Colombia'
