# =============================================================================
# IPFLang Jurisdiction: PCT-JO
# =============================================================================
# Entry of national phase in Jordan
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-JO.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Jordan'
...
# File name: PCT-JO-OFF
# File content: Official fees for PCT national phase: Jordan
# Valid until n/a
...
#examination fee payable only upon invitation from office 
#publication fee payable only after acceptance
#annuities seem to be due only after grant ("for maintaining the patent in force")
...
RETURN Currency AS 'JOD'
RETURN Jurisdiction AS 'JO'
RETURN JurisdictionName AS 'Entry of national phase in Jordan'
