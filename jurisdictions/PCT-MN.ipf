# =============================================================================
# IPFLang Jurisdiction: PCT-MN
# =============================================================================
# Entry of national phase in Mongolia
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-MN.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Mongolia'
...
# File name: PCT-MN-OFF
# File content: Official fees for PCT national phase: Mongolia
# Valid until n/a
...
# Translation fee per word into Mongolian
...
RETURN Currency AS 'MNT'
RETURN Jurisdiction AS 'MN'
RETURN JurisdictionName AS 'Entry of national phase in Mongolia'
