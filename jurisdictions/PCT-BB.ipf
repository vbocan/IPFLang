# =============================================================================
# IPFLang Jurisdiction: PCT-BB
# =============================================================================
# Entry of national phase in Barbados
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-BB.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Barbados'
...
# File name: PCT-BB-OFF
# File content: Official fees for PCT national phase: Barbados
# Valid until n/a
...
YIELD 200<BBD> IF RenMonth GTE 12 #year 2
YIELD 300<BBD> IF RenMonth GTE 24 #year 3
ENDCOMPUTE
...
RETURN Currency AS 'BBD'
RETURN Jurisdiction AS 'BB'
RETURN JurisdictionName AS 'Entry of national phase in Barbados'
