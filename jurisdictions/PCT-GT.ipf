# =============================================================================
# IPFLang Jurisdiction: PCT-GT
# =============================================================================
# Entry of national phase in Guatemala
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-GT.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Guatemala'
...
# File name: PCT-GT-OFF
# File content: Official fees for PCT national phase: Guatemala
# Valid until n/a
...
RETURN Currency AS 'GTQ'
RETURN Jurisdiction AS 'GT'
RETURN JurisdictionName AS 'Entry of national phase in Guatemala'
