# =============================================================================
# IPFLang Jurisdiction: PCT-PA
# =============================================================================
# Entry of national phase in Panama
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-PA.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Panama'
...
# File name: PCT-PA-OFF
# File content: Official fees for PCT national phase: Panama
# Valid until n/a
...
RETURN Jurisdiction AS 'PA'
RETURN JurisdictionName AS 'Entry of national phase in Panama'
