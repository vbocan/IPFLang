# =============================================================================
# IPFLang Jurisdiction: PCT-UZ
# =============================================================================
# Entry of national phase in Uzbekistan
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-UZ.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Uzbekistan'
...
# File name: PCT-UZ-OFF
# File content: Official fees for PCT national phase: Uzbekistan
# Valid until n/a
...
LET Fee1 AS 210
YIELD Fee1*(IndependentClaimCount -1) IF IndependentClaimCount GT 1
ENDCOMPUTE

COMPUTE FEE OFF_DependentClaimFee
LET Fee1 AS 84 #>10
LET Fee2 AS 42 #>20

YIELD Fee1*(DependentClaimCount - 10) IF DependentClaimCount GT 10 AND DependentClaimCount LTE 20
YIELD Fee1*10 + Fee2*(DependentClaimCount - 20) IF DependentClaimCount GT 20
ENDCOMPUTE

COMPUTE FEE OFF_Renewal #seems to be payable at once
LET Fee1 AS 840
YIELD Fee1
ENDCOMPUTE
...
# Translation fee per word into Russian, Uzbek
...
VERIFY COMPLETE FEE OFF_DependentClaimFee
VERIFY MONOTONIC FEE OFF_IndependentClaimFee WITH RESPECT TO ClaimCount
VERIFY MONOTONIC FEE OFF_DependentClaimFee WITH RESPECT TO ClaimCount
...
RETURN Jurisdiction AS 'UZ'
RETURN JurisdictionName AS 'Entry of national phase in Uzbekistan'
