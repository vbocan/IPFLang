# =============================================================================
# IPFLang Jurisdiction: PCT-VN
# =============================================================================
# Entry of national phase in Vietnam
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-VN.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Vietnam'
...
# File name: PCT-VN-OFF
# File content: Official fees for PCT national phase: Viet Nam
# Valid until n/a
# Is newer than 30 days: False
# Fees keywords: ['claims', 'priority', 'sheet']
...
COMPUTE FEE OFF_FormalExaminationFee #FORMAL EXAM
LET Fee1 AS 180000
LET SFee AS 8000
YIELD Fee1
YIELD SFee*(SheetCount-6) IF SheetCount GT 6
ENDCOMPUTE

COMPUTE FEE OFF_ExaminationFee #42 months of priority - SUBSTANTIVE EXAM
LET Fee1 AS 720000
LET SFee AS 32000
YIELD Fee1
YIELD SFee*(SheetCount-6) IF SheetCount GT 6
...
# Translation fee per word into Vietnamese
...
VERIFY COMPLETE FEE OFF_FormalExaminationFee
...
RETURN Currency AS 'VND'
RETURN Jurisdiction AS 'VN'
RETURN JurisdictionName AS 'Entry of national phase in Vietnam'
