# =============================================================================
# IPFLang Jurisdiction: PCT-EA
# =============================================================================
# Entry of regional phase in Eurasia
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-EA.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of regional phase in Eurasia'
...
RETURN Jurisdiction AS 'EA'
RETURN JurisdictionName AS 'Entry of regional phase in Eurasia'
