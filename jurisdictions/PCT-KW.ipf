# =============================================================================
# IPFLang Jurisdiction: PCT-KW
# =============================================================================
# Entry of national phase in Kuwait
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-KW.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Kuwait'
...
# File name: PCT-KW-OFF
# File content: Official fees for PCT national phase: Kuwait
# Valid until n/a
...
RETURN Currency AS 'KWD'
RETURN Jurisdiction AS 'KW'
RETURN JurisdictionName AS 'Entry of national phase in Kuwait'
