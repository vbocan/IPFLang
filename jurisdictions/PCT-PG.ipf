# =============================================================================
# IPFLang Jurisdiction: PCT-PG
# =============================================================================
# Entry of national phase in Papua New Guinea
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-PG.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Papua New Guinea'
...
# File name: PCT-PG-OFF
# File content: Official fees for PCT national phase: Papua New Guinea
# Valid until n/a
...
RETURN Currency AS 'PGK'
RETURN Jurisdiction AS 'PG'
RETURN JurisdictionName AS 'Entry of national phase in Papua New Guinea'
