# =============================================================================
# IPFLang Jurisdiction: PCT-IQ
# =============================================================================
# Entry of national phase in Iraq
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-IQ.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Iraq'
...
# File name: PCT-IQ-OFF
# File content: Official fees for PCT national phase: Iraq
# Valid until n/a
...
RETURN Currency AS 'IQD'
RETURN Jurisdiction AS 'IQ'
RETURN JurisdictionName AS 'Entry of national phase in Iraq'
