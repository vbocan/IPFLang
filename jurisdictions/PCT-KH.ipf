# =============================================================================
# IPFLang Jurisdiction: PCT-KH
# =============================================================================
# Entry of national phase in Cambodia
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-KH.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Cambodia'
...
# File name: PCT-KH-OFF
# File content: Official fees for PCT national phase: Cambodia
# Valid until n/a
...
LET RenFee2 AS 80000
LET RenFee3 AS 12000
...
# Translation fee per word into Khmer
...
RETURN Currency AS 'KHR'
RETURN Jurisdiction AS 'KH'
RETURN JurisdictionName AS 'Entry of national phase in Cambodia'
