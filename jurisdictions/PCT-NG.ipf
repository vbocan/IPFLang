# =============================================================================
# IPFLang Jurisdiction: PCT-NG
# =============================================================================
# Entry of national phase in Nigeria
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-NG.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Nigeria'
...
# File name: PCT-NG-OFF
# File content: Official fees for PCT national phase: Nigeria
# Valid until n/a
...
RETURN Currency AS 'NGN'
RETURN Jurisdiction AS 'NG'
RETURN JurisdictionName AS 'Entry of national phase in Nigeria'
