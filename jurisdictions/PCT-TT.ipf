# =============================================================================
# IPFLang Jurisdiction: PCT-TT
# =============================================================================
# Entry of national phase in Trinidad and Tobago
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-TT.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Trinidad and Tobago'
...
# File name: PCT-TT-OFF
# File content: Official fees for PCT national phase: Trinidad and Tobago
# Valid until n/a
...
RETURN Currency AS 'TTD'
RETURN Jurisdiction AS 'TT'
RETURN JurisdictionName AS 'Entry of national phase in Trinidad and Tobago'
