# =============================================================================
# IPFLang Jurisdiction: PCT-MG
# =============================================================================
# Entry of national phase in Madagascar
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-MG.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Madagascar'
...
# File name: PCT-MG-OFF
# File content: Official fees for PCT national phase: Madagascar
# Valid until n/a
...
# Translation fee per word into French
...
RETURN Currency AS 'MGA'
RETURN Jurisdiction AS 'MG'
RETURN JurisdictionName AS 'Entry of national phase in Madagascar'
