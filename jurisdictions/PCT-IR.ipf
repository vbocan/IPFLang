# =============================================================================
# IPFLang Jurisdiction: PCT-IR
# =============================================================================
# Entry of national phase in Iran
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-IR.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Iran'
...
# File name: PCT-IR-OFF
# File content: Official fees for PCT national phase: Iran (Islamic Republic of)
# Valid until n/a
...
#Annuities payable 2 months prior to first anniversary of NPE
...
# Translation fee per word into Farsi
...
RETURN Currency AS 'IRR'
RETURN Jurisdiction AS 'IR'
RETURN JurisdictionName AS 'Entry of national phase in Iran'
