# =============================================================================
# IPFLang Jurisdiction: PCT-SG
# =============================================================================
# Entry of national phase in Singapore
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-SG.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Singapore'
...
# File name: PCT-SG-OFF
# File content: Official fees for PCT national phase: Singapore
# Valid until n/a
...
LET CFee AS 40
YIELD Fee1
YIELD CFee*(ClaimCount-20) IF ClaimCount GT 20
ENDCOMPUTE
...
RETURN Currency AS 'SGD'
RETURN Jurisdiction AS 'SG'
RETURN JurisdictionName AS 'Entry of national phase in Singapore'
