# =============================================================================
# IPFLang Jurisdiction: PCT-KR
# =============================================================================
# Entry of national phase in Republic of Korea
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-KR.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Republic of Korea'
...
# File name: PCT-KR-OFF
# File content: Official fees for PCT national phase: Republic of Korea
# Valid until n/a
# Is newer than 30 days: False
# Fees keywords: ['sheet', 'claim']

COMPUTE FEE OFF_BasicNationalFee
LET Fee1 AS 46000 
LET Discount AS 0.7 
YIELD Fee1
YIELD -Fee1*Discount IF EntitySize EQ Entity_Person
ENDCOMPUTE
...
COMPUTE FEE OFF_ExaminationFee OPTIONAL #3 years of IFD
LET Fee1 AS 143000
LET FeeClaim AS 44000
LET Discount AS 0.7
YIELD Fee1 + FeeClaim*ClaimCount
YIELD -Discount * (Fee1 + FeeClaim*ClaimCount) IF EntitySize EQ Entity_Person
ENDCOMPUTE
...
# Translation fee per word into Korean
...
RETURN Currency AS 'KRW'
RETURN Jurisdiction AS 'KR'
RETURN JurisdictionName AS 'Entry of national phase in Republic of Korea'
