# =============================================================================
# IPFLang Jurisdiction: PCT-SV
# =============================================================================
# Entry of national phase in El Salvador
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-SV.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in El Salvador'
...
# File name: PCT-SV-OFF
# File content: Official fees for PCT national phase: El Salvador
# Valid until n/a
...
RETURN Jurisdiction AS 'SV'
RETURN JurisdictionName AS 'Entry of national phase in El Salvador'
