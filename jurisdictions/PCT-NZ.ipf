# =============================================================================
# IPFLang Jurisdiction: PCT-NZ
# =============================================================================
# Entry of national phase in New Zealand
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-NZ.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in New Zealand'
...
# File name: PCT-NZ-OFF
# File content: Official fees for PCT national phase: New Zealand
# Valid until n/a
...
#annuities as of 4th year of IFD payable at grant
#examination within 5 years of IFD
...
RETURN Currency AS 'NZD'
RETURN Jurisdiction AS 'NZ'
RETURN JurisdictionName AS 'Entry of national phase in New Zealand'
