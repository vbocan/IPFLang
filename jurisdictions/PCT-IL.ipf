# =============================================================================
# IPFLang Jurisdiction: PCT-IL
# =============================================================================
# Entry of national phase in Israel
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-IL.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Israel'
...
# File name: PCT-IL-OFF
# File content: Official fees for PCT national phase: Israel
# Valid until n/a
...
LET Fee1 AS 273
YIELD Fee1*( ( SheetCount - 100 ) / 50 ) IF SheetCount GT 100
ENDCOMPUTE

COMPUTE FEE OFF_ClaimFee
LET Fee1 AS 560
YIELD Fee1*(ClaimCount-50) IF ClaimCount GT 50
ENDCOMPUTE

#annuities after examination
...
RETURN Currency AS 'ILS'
RETURN Jurisdiction AS 'IL'
RETURN JurisdictionName AS 'Entry of national phase in Israel'
