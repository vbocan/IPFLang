# =============================================================================
# IPFLang Jurisdiction: PCT-OM
# =============================================================================
# Entry of national phase in Oman
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-OM.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Oman'
...
# File name: PCT-OM-OFF
# File content: Official fees for PCT national phase: Oman
# Valid until n/a
...
RETURN Currency AS 'OMR'
RETURN Jurisdiction AS 'OM'
RETURN JurisdictionName AS 'Entry of national phase in Oman'
