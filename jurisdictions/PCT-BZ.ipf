# =============================================================================
# IPFLang Jurisdiction: PCT-BZ
# =============================================================================
# Entry of national phase in Belize
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-BZ.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Belize'
...
# File name: PCT-BZ-OFF
# File content: Official fees for PCT national phase: Belize
# Valid until n/a
...
YIELD 100<BZD>
YIELD 200<BZD> IF RenMonth GTE 12 #year 2
YIELD 300<BZD> IF RenMonth GTE 24 #year 3
ENDCOMPUTE
...
RETURN Currency AS 'BZD'
RETURN Jurisdiction AS 'BZ'
RETURN JurisdictionName AS 'Entry of national phase in Belize'
