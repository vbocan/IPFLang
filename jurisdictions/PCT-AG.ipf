# =============================================================================
# IPFLang Jurisdiction: PCT-AG
# =============================================================================
# Entry of national phase in Antigua & Barbuda
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-AG.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Antigua & Barbuda'
...
# File name: PCT-AG-OFF
# File content: Official fees for PCT national phase: Antigua & Barbuda
# Valid until n/a
...
YIELD 10*(ClaimCount-20) IF ClaimCount GT 20
ENDCOMPUTE
...
YIELD 1000+50 #Fee for grant + Fee for publication of grant of patent
ENDCOMPUTE
...
YIELD 200 #for year 2 (assumption: the NPE will always occur a year after filing date)
YIELD 300<XCD> IF RenMonth GTE 12 #year 3
YIELD 400<XCD> IF RenMonth GTE 24 #year 4
ENDCOMPUTE
...
RETURN Currency AS 'XCD'
RETURN Jurisdiction AS 'AG'
RETURN JurisdictionName AS 'Entry of national phase in Antigua & Barbuda'
