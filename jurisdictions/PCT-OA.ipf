# =============================================================================
# IPFLang Jurisdiction: PCT-OA
# =============================================================================
# Entry of regional phase in OAPI
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-OA.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of regional phase in OAPI'
...
# need to verify with office if really payable upon entry
COMPUTE FEE OFF_Renewal
LET RenMonth AS ROUND ( ApplicationDate!MONTHSTONOW ) #calculate difference in months to today

YIELD 220000<XAF> IF RenMonth GTE 12
YIELD 220000<XAF> IF RenMonth GTE 24
...
VERIFY COMPLETE FEE Off_AcceptanceFee
...
RETURN Currency AS 'XAF'
RETURN Jurisdiction AS 'OA'
RETURN JurisdictionName AS 'Entry of regional phase in OAPI'
