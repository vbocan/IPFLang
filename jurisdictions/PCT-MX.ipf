# =============================================================================
# IPFLang Jurisdiction: PCT-MX
# =============================================================================
# Entry of national phase in Mexico
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-MX.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Mexico'
...
# File name: PCT-MX-OFF
# File content: Official fees for PCT national phase: Mexico
# Valid until n/a
...
YIELD Fee2 IF OfficeElected EQ TRUE
ENDCOMPUTE
...
#no mention about annuities
#50% discount on select fees for inventors and SMEs not clear from WIPO page 
...
RETURN Currency AS 'MXN'
RETURN Jurisdiction AS 'MX'
RETURN JurisdictionName AS 'Entry of national phase in Mexico'
