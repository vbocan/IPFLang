# =============================================================================
# IPFLang Jurisdiction: PCT-BR
# =============================================================================
# Entry of national phase in Brazil
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-BR.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Brazil'
...
YIELD 295 # year 1
YIELD 295<BRL> IF RenMonth GTE 12 # year 2
YIELD 780<BRL> IF RenMonth GTE 24 # year 3
ENDCOMPUTE
...
# Translation fee per word into Portuguese
...
RETURN Currency AS 'BRL'
RETURN Jurisdiction AS 'BR'
RETURN JurisdictionName AS 'Entry of national phase in Brazil'
