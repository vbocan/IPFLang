# =============================================================================
# IPFLang Jurisdiction: PCT-AO
# =============================================================================
# Entry of national phase in Angola
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-AO.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase in Angola'
...
# File name: PCT-AO-OFF
# File content: Official fees for PCT regional phase: Angola
# Valid until n/a

COMPUTE FEE OFF_BasicNationalFee
YIELD 27722<AOA>
YIELD 792*(ClaimCount-15) IF ClaimCount GT 15
ENDCOMPUTE

COMPUTE FEE OFF_ExaminationFee OPTIONAL
#examination fee payable within 3 years of IFD
YIELD 27280<AOA>
ENDCOMPUTE
...
YIELD 3784 #for 1st anniversary (assumption: the NPE will always occur a year after filing date)
YIELD 4050<AOA> IF RenMonth GTE 12 #2nd anniversary
YIELD 4400<AOA> IF RenMonth GTE 24 #3rd anniversary
ENDCOMPUTE
...
RETURN Currency AS 'AOA'
RETURN Jurisdiction AS 'AO'
RETURN JurisdictionName AS 'Entry of national phase in Angola'
