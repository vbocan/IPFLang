# =============================================================================
# IPFLang Jurisdiction: PCT-DZ
# =============================================================================
# Entry of national phase entry in Algeria
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-DZ.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase entry in Algeria'
...
# File name: PCT-DZ-OFF
# File content: Official fees for PCT national phase: Algeria
# Valid until n/a
...
LET Fee1 AS 1200 #per each 5 exceeding 10
YIELD Fee1*( ( SheetCount - 10 ) / 5 ) IF SheetCount GT 10
ENDCOMPUTE
...
RETURN Currency AS 'DZD'
RETURN Jurisdiction AS 'DZ'
RETURN JurisdictionName AS 'Entry of national phase entry in Algeria'
