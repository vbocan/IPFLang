# =============================================================================
# IPFLang Jurisdiction: PCT-CU
# =============================================================================
# Entry of national phase entry in Cuba
#
...
#
# Usage:
#   dotnet run --project ../src/IPFLang.CLI -- run ./PCT-CU.ipf
#
# =============================================================================

VERSION '2024.1' EFFECTIVE 2024-01-01 DESCRIPTION 'Entry of national phase entry in Cuba'
...
# File name: PCT-CU-OFF
# File content: Official fees for PCT national phase: Cuba
# Valid until n/a
...
#independent
LET Fee1 AS 1920
YIELD (IndependentClaimCount-1) * Fee1 IF IndependentClaimCount GT 1

#multiple dependent
LET Fee2 AS 2400
YIELD MultipleDependentClaimCount * Fee2

#group of 10 dependent
LET Fee3 AS 1920
YIELD ( DependentClaimCount / 10 ) * Fee3

ENDCOMPUTE

COMPUTE FEE OFF_Renewal3
LET RenFee AS 4800
LET RenMonth AS ApplicationDate!MONTHSTONOW #calculate difference in months to today
YIELD RenFee IF RenMonth GTE 12 #3rd annuity to be paid before 3rd year commences
ENDCOMPUTE
...
# Translation fee per word into Spanish
...
RETURN Currency AS 'CUP'
RETURN Jurisdiction AS 'CU'
RETURN JurisdictionName AS 'Entry of national phase entry in Cuba'
